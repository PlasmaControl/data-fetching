...
shots = [185769] #[163303,175970] #175970 is Colin's good modulation shot; 154764 is David Eldon's

tmin = 1000
tmax = 5000

output_file='new_data.pkl'
...
trial_fits=['csaps_1d','mtanh_1d'] #'linear_interp_1d','spline_1d'] #,'mtanh_1d']
