...
if isinstance(cfg['data']['shots'],str) and cfg['data']['shots'][-4:] == ".npy":
    all_shots=np.load(cfg['data']['shots'])
else:
    all_shots=cfg['data']['shots']

### % YSC: start looping block
_SHOT_ARR_DIR = "/home/chungy/packages/data-fetching/data"
_SAVE_DATA_DIR = "/home/chungy/"
for arr_idx in range(1, 18):
    arr_name = f"arr_{arr_idx}.npy"
