 ...
 *
 * replace instances of mp_malloc with use of scratch structure passed
 * as an argument.
 */
...
#define FITTING_MAX_PAR 5
#define FITTING_NRINGTHOM 41 //also change in test_fit.c
	  ...
	  mp_result *result)
{
  ...
  {
    float timeNBI;
    double step[FITTING_MAX_PAR];
    double dstep[FITTING_MAX_PAR];
    double ddrtol[FITTING_MAX_PAR];
    double ddatol[FITTING_MAX_PAR];
    double ulim[FITTING_MAX_PAR];
    double llim[FITTING_MAX_PAR];
    double qtf[FITTING_MAX_PAR];
    double x[FITTING_MAX_PAR];
    double xnew[FITTING_MAX_PAR];
    double diag[FITTING_MAX_PAR];
    double wa1[FITTING_MAX_PAR];
    double wa2[FITTING_MAX_PAR];
    double wa3[FITTING_MAX_PAR];
    double wa4[FITTING_NRINGTHOM];
    double fvec[FITTING_NRINGTHOM];
    double fjac[FITTING_MAX_PAR*FITTING_NRINGTHOM];
    int pfixed[FITTING_MAX_PAR];
    int mpside[FITTING_MAX_PAR];
    int ddebug[FITTING_MAX_PAR];
    int ifree[FITTING_MAX_PAR];
    int ipvt[FITTING_MAX_PAR];
    int qulim[FITTING_MAX_PAR];
    int qllim[FITTING_MAX_PAR];
  };

  struct mp_scratch* mp_scratch = malloc(sizeof(struct mp_scratch));
  ...
  step = mp_scratch->step;
  dstep = mp_scratch->dstep;
  mpside = mp_scratch->mpside;
  ddebug = mp_scratch->ddebug;
  ddrtol = mp_scratch->ddrtol;
  ddatol = mp_scratch->ddatol;
  ...
  if (pars) {
    ...
    qulim = mp_scratch->qulim;
    qllim = mp_scratch->qllim;
    ulim = mp_scratch->ulim;
    llim = mp_scratch->llim;
  ...
  fvec = mp_scratch->fvec;
  qtf = mp_scratch->qtf;
  x = mp_scratch->x;
  xnew = mp_scratch->xnew;
  fjac = mp_scratch->fjac;
  ldfjac = m;
  ...
  diag = mp_scratch->diag;
  wa1 = mp_scratch->wa1;
  wa2 = mp_scratch->wa2;
  wa3 = mp_scratch->wa3;
  wa4 = mp_scratch->wa4;
  ipvt = mp_scratch->ipvt;
